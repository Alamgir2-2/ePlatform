    ...
    return (
        <div className="flex justify-center items-center min-h-screen">
            <div className="w-full max-w-lg p-8 bg-white rounded-lg shadow-lg">
                <h2 className="text-5xl text-black font-bold mb-8 text-center">Sign Up</h2>
                <form>
                    <div className="mb-6 flex items-center">
                        <label htmlFor="name" className="block text-gray-700 text-lg font-bold w-1/3">
                            Name
                        </label>
                        <input 
                            type="text" 
                ...
                <p className="text-center text-gray-600 text-lg mt-6">
                    ...
                    <Link to="/login" className="text-blue-900 hover:text-blue-700 font-bold"> Log in</Link>
                </p>
            </div>
        </div>
    );
